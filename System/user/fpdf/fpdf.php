...
if(!class_exists('FPDF')) {
	...
	class FPDF 	{
		...
		var $FechaGen;           //Fecha de generacion del reporte
		...
		*******************************************************************************/
		function FPDF($orientation='P',$unit='mm',$format='A4')
		{
			...
			if(is_string($format))
			{
				...
				elseif($format=='letter')
					$format=array(780,1008);
				elseif($format=='letter2')
					$format=array(695,900);	
				elseif($format=='letter3')
					$format=array(723,980);
				elseif($format=='legal')
					$format=array(682,1108);
				else
		...
		function Footer()
		{
		    ...
		    $this->Cell(100,5,'Fecha de Generacion: '.$this->FechaGen,0,0,'L');
			$this->Cell(0,5,'Pagina '.$this->PageNo().' de {nb}',0,0,'R');
		    $this->SetY($this->h - 10);
		    $this->Cell(0,5,'Paquete Nro. '.CCGetSession("PRUEBAIDN"),0,0,'R');
		}
		...
		//		echo substr($type,0,3);
		//		exit;
				if(strlen($type)>3 && substr($type,0,3) == "php")
		...
		*******************************************************************************/
		...
		function _parsephp($file)
		{
			...
			if(fread($f,8)!=chr(137).'PNG'.chr(13).chr(10).chr(26).chr(10))
				$this->Error('Not a PHP-PNG file: '.$file);
			//Read header chunk
			fread($f,4);
			if(fread($f,4)!='IHDR')
